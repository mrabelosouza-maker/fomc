...
I appreciated and supported the language in the post-meeting statement about the recent data, which reflects an appropriate characterization of the unemployment data as showing "some signs of stabilization." It will take time to get a clear signal about stability in the labor market. My view is that we should continue to focus on downside risks to our employment mandate, and the description of the labor market is helpful to communicate that we are not overly confident. History tells us that the labor market can appear to be stable right up until it isn't.
